...
public class TextPromptForm : Form
{
    ...
    private readonly Button _btnOk = new() { Width = 80, Text = Strings.T("Common_OK"), DialogResult = DialogResult.OK };
    private readonly Button _btnCancel = new() { Width = 80, Text = Strings.T("Common_Cancel"), DialogResult = DialogResult.Cancel };
    ...
    public TextPromptForm(string title, string prompt, string initialValue = "")
    {
        ...
        _btnOk.Click += (_, e) =>
        {
            if (string.IsNullOrWhiteSpace(Value))
            {
                ...
                MessageBox.Show(this, Strings.T("TextPrompt_Msg_EnterValue"), Strings.T("Common_Warning"), MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        };
    }
}
